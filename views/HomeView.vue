<script setup lang="ts">
    ...
    const createUser = async () => {
        ...
        try {
            ...
            console.log('Fehler wird abgefangen:', err);  // Überprüft, ob der Fehler hier ankommt
    console.error('Fehler beim Setzen des Benutzers:', err); // Loggt den Fehler
...
<div class="p-8 bg-gray-800 rounded-lg shadow-lg w-full max-w-md">
    ...
    <p v-if="error" class="text-red-400 text-center mt-2" > {{ error }}
